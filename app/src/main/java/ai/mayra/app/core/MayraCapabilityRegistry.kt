...
object MayraCapabilityRegistry {
    val capabilities: List<MayraCapability> = listOf(
        ...
        MayraCapability("core.runtime-boundary", "Core assistant", "Audited typed runtime boundary", MayraCapabilityStatus.DONE, "Typed success/failure results, handler isolation, action idempotency and immutable in-memory activity records are covered by regressions."),
        MayraCapability("core.runtime-integration", "Core assistant", "Concrete assistant runtime integration", MayraCapabilityStatus.IN_PROGRESS, "Next milestone: connect normal-answer and document-retrieval adapters, persist activity history and add confirmed device-action execution."),
        ...
        MayraCapability("actions.typed-execution", "Actions", "Typed confirmed action execution", MayraCapabilityStatus.IN_PROGRESS, "Confirmation, idempotency and audit records exist; persistent history and concrete action adapters remain."),
