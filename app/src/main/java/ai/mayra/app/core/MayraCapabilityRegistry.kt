...
object MayraCapabilityRegistry {
    val capabilities: List<MayraCapability> = listOf(
        ...
        MayraCapability("core.runtime-integration", "Core assistant", "Concrete assistant runtime integration", MayraCapabilityStatus.IN_PROGRESS, "Next milestone: connect normal-answer and Current-only document-retrieval adapters, then confirmed device-action execution and user-facing history."),
        ...
        MayraCapability("actions.typed-execution", "Actions", "Typed confirmed action execution", MayraCapabilityStatus.IN_PROGRESS, "Confirmation tokens, duplicate prevention and persistent audit records exist; concrete action adapters and user-visible history remain."),
